...
namespace Leverage.Areas.Admin.Controllers
{
    ...
    public class ServiceController : Controller
    {
        ...
        public ServiceController(LgContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Icon,Header,Description")] Services services)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Icon,Header,Description")] Services services)
        {
            if (id != services.ID)
            {
                return NotFound();
